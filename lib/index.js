...
(function() {
  ...
  CoffeeClassOrm = (function() {
    ...
    CoffeeClassOrm.prototype.fetch_all = function(options, done) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      ...
      this.select_all(options, function(json) {
        var collection;
        if (options === 'by_id' || options.by_id) {
          collection = [];
          _.each(json, function(instance_data, id) {
            return collection[id] = new _this.constructor(instance_data);
          });
    ...
    CoffeeClassOrm.prototype.recreate = function(done) {
      var _this = this;
    ...
    CoffeeClassOrm.prototype.db_destroy_table = function(done) {
      var _this = this;
    ...
    CoffeeClassOrm.db_create_table = function(_arg, done) {
      var columns, engine, fail, force, forced, indexes, primary_key, str, success, _base, _ref,
        _this = this;
    ...
    CoffeeClassOrm.prototype.select_all = function(options, done) {
      var _this = this;
      if (_.isFunction(options)) {
        done = options;
        options = {};
      }
      return this.select(options, function(err, results) {
        var byId;
        byId = [];
        (_(results)).each(function(row) {
